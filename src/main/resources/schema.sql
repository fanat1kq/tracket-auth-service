CREATE TABLE IF NOT EXISTS authorization_service.outbox_events
(
...
CREATE TABLE IF NOT EXISTS authorization_service.oauth2_authorization
(
    id                            varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS authorization_service.oauth2_authorization_consent
(
    registered_client_id varchar(100)  NOT NULL,
    principal_name       varchar(200)  NOT NULL,
